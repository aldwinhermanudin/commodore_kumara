...
void SPI::init(int mosiPin, int misoPin, int clkPin, int csPin) {
    ...
    bus_config.intr_flags	   = 0;		  // disable this fixes "intr flag not allowed" issue
	...
	dev_config.mode             = 0;	// SPI Mode 0 to 3
	dev_config.duty_cycle_pos   = 0;
	dev_config.cs_ena_posttrans = 0;
	dev_config.cs_ena_pretrans  = 0;
	dev_config.clock_speed_hz   = SPI_MASTER_FREQ_10M; //freq
	//dev_config.spics_io_num     = csPin; //
	dev_config.spics_io_num     = -1;	// allow for control of CS pin manually
 ...
 * @param [in] host The SPI host to use.  Either HSPI_HOST or VSPI_HOST (default).
 */
